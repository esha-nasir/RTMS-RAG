...
# Compatibility wrapper: load implementation from src/rag.py
_src_path = os.path.join(os.path.dirname(__file__), "src", "rag.py")
spec = importlib.util.spec_from_file_location("_rtms_src_rag", _src_path)
_mod = importlib.util.module_from_spec(spec)
spec.loader.exec_module(_mod)

# Export public symbols from the src module
