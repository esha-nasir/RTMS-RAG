...
# Compatibility wrapper: load implementation from src/retrieve.py
_src_path = os.path.join(os.path.dirname(__file__), "src", "retrieve.py")
spec = importlib.util.spec_from_file_location("_rtms_src_retrieve", _src_path)
